...
class _ChatBoxNewState extends State<ChatBoxNew> {
  ...
  addmessage(String chatroomID, chatroomMap) {
    ...
    FirebaseFirestore.instance
        .collection("ChatRoom")
        .doc(chatroomID)
        .collection("messages") //the document is an id store place
        ...
        children: <Widget>[
          ...
          Expanded(
            child: TextField(
              ...
              onEditingComplete: () {
                createMessageMap(messageController.text);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          //appBar dark mode color 0xff1b1b2f
          backgroundColor: Get.isDarkMode
              ? Color(0xff1b1b2f)
              : Color(0xff16697a), //appBar light mode color 0xff16697a
          title: Text(
            receiverName,
            style: TextStyle(
              fontSize: 20.0,
