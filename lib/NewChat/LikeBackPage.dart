    ...
    return GetBuilder<RegistrationController>(builder: (_) {
      return Scaffold(
        ...
        body: Padding(
          ...
          child: _.likeBackData.petName != null
              ? Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(
                          "${_.likeBackData.location.country}, ${_.likeBackData.location.area}",
                          style: TextStyle(
                            fontSize: 18.0,
                            color: Colors.white,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        FloatingActionButton(
                          ...
                          onPressed: () {
                            regController
                                .matchUsers(ProfileData(uid: widget.uid));
                          },
